...
const Button = ({ children, variant = 'primary', loading = false, className = '', ...props }) => {
    const baseClasses = 'w-full py-3 px-4 font-medium rounded-lg transition-all duration-300 flex items-center justify-center'

    const variants = {
        primary: 'bg-[linear-gradient(135deg,#a855f7_0%,#6366f1_100%)] text-white hover:shadow-lg transform hover:-translate-y-0.5',
